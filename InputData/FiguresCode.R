...
Data <- read.table('Fermentation_Kinetics.txt',header=TRUE,sep="\t")
Map <- read.table('Fermentation_Map.txt',header=TRUE,sep="\t")
...
Counts <- read.table("Fermentation_5SP_Counts.txt",header=TRUE,sep="\t")
